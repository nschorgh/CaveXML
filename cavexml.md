...
National cave identification number: optional 3-letter organization code + cave registry number, separated by dashes, e.g. HSS-234/7, where HSS stands for Hawaii Speleological Survey. For small countries, this might just be the national cave number, e.g. 1234/5.  
