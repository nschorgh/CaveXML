...
i) An unsigned integer or an ExtendedUnsignedInteger can be followed by a comment. These comments may be be ignored during a query, so few restrictions are placed on their form.  
